...
all requests for a Web site”. Therefore, performance considerations could be a liabilitie
...
concerns such as authorization, security, and the rendering of views by instanciating
 view controllers (MVP presenter) which are bound to the model. Hence  
...
<ul>
	<li>Most of the time, the location of a bug is in the controller. There is even 
	...
	application.</li>
	<li>Developers and Web designers can work efficiently in a collaborative environment (Subversion, GIT, ...).</li>	
</ul>
